function act=cox_mutualP_simul(x, times, line)
...
for n=1:times
    ...
    if act(n,1) == 1
        ...
        % crushing
        % disappear in 1sec - disappear when disappear == 3 
        if rand < 370/1174
            disappear = 3;
            time(n,1) = 1;
            % disappear in 1-2sec - disappear when disappear == 3 
        elseif 370/1174 < rand && rand < 496/1174
            disappear = 3;
            time(n,1) = 2;
            %disappear in 2-3sec - disappear when disappear == 3 
        elseif rand > 496/1174
            disappear = 3;
            time(n,1) = 3;
        end
    end
